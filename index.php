...
<div class="hero">
    <h1>Pastimes Second-Hand Fashion eShop</h1>
    <p>Our goal is to deliver safe, stylish pre-owned clothing with fast checkout, reliable inventory, and admin-managed stock control.</p>

    <div style="margin-top:20px;">
        <a class="btn primary" href="user/products.php">eShop</a>
        <a class="btn secondary" href="user/cart.php">Show Cart</a>
    </div>
</div>
